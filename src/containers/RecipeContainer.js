...
const RecipeContainer=({id})=>{
    ...
    return(
        <section className="bg-white md:bg-[url('/assets/images/2026-recetas-detalle.jpg')] bg-cover bg-center bg-no-repeat min-h-screen w-full flex items-center justify-center pt-5 pb-5">
